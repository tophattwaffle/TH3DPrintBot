...
namespace TH3DPrintBot
{
    public class Program
    {
        ...
        /// <summary>
        /// Initializes the bot and its required services and then subscribes to its events.
        /// </summary>
        /// <returns>No object or value is returned by this method when it completes.</returns>
        public async Task MainAsync()
        {
            Console.Title = "TH3D Discord Bot";
        ...
        private async Task CommandExecutedEventHandler(ICommandContext context, IResult result)
        {
            ...
            switch (result.Error)
            {
                ...
                case CommandError.Exception:
                    alert = true;
                    await context.Channel.SendMessageAsync("Something bad happened! I logged the error for my creator.");
