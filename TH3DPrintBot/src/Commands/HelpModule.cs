    ...
    public class HelpModule : ModuleBase<SocketCommandContext>
    {
            ...
            string command)
        {
            ...
            for (var i = 0; i < result.Commands.Count; ++i)
            {
                ...
                embed.WithFooter((result.Commands.Count > 1 ? $"Result {i + 1}/{result.Commands.Count}." : string.Empty) +
